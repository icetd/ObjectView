...
public:
	...
	void setPlan(std::vector<Vertex> &goalList) {
		m_verticesPath = goalList;
	}
...
private:
	...
	void loadPGMAndGenerateMap(const std::string& yamlname, const std::string& pgmname, float spacing);
